...
- (NSMutableDictionary*)genericParameters
{
	...
	NSString *advertiserIdentifier = [TapjoyConnect getAdvertiserIdentifier];
	if (advertiserIdentifier)
	{
		[genericDict setObject:advertiserIdentifier forKey:TJC_ADVERTISER_ID];
	}
...
//	{
//		return [[[UIDevice currentDevice] identifierForAdvertising] UUIDString];
//	}
#endif
