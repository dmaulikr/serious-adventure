...
-(id) init {
	...
	if ((self = [super init])) {
		...
		rectBetMaxButton = CGRectMake(5, 67.5, 75, 30);
		rectBetOneButton = CGRectMake(75, 67.5, 75, 30);
		rectSpinButton = CGRectMake(205.5, 70.5, 106, 24);
		rectPayoutButton = CGRectMake(88, 118, 30, 30);
        ...
        if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
        {
            ...
            {
                ledDisplays[0].position = ccp(15, 130);
                ledDisplays[1].position = ccp(27.5, 130);
                ledDisplays[2].position = ccp(41, 130);
                ledDisplays[3].position = ccp(53.5, 130);
                ledDisplays[4].position = ccp(66, 130);
                
                ledDisplays[5].position = ccp(211.5, 130);
                ledDisplays[6].position = ccp(224.5, 130);
                
                ledDisplays[7].position = ccp(253, 130);
                ledDisplays[8].position = ccp(266, 130);
                ledDisplays[9].position = ccp(279, 130);
                ledDisplays[10].position = ccp(292.5, 130);
                ledDisplays[11].position = ccp(305, 130);
            }
        }
