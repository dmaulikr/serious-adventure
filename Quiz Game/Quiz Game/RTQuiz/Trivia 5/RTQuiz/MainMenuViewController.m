...
- (IBAction)btnShareScorePressed:(UIButton *)sender {
    ...
    NSString *currentScore = [prefs valueForKey:@"current_score"];
    if (currentScore == NULL) {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"" message:@"Go play a round and then share your score on Facebook." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        return;
    }
...
-(void)postAtFacebook{
    ...
    NSMutableDictionary * params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                    nil];
    [params setObject:[NSString stringWithFormat:@"%@   is The Highest Scores                   See if you can beat my high score in Ultimate Trivia: Impossible Video Game Trivia",currentScore] forKey:@"message"];
...
-(IBAction)rateApp:(id)sender {
  NSURL *siteURL = [NSURL URLWithString:@"http://itunes.apple.com/APP-ID"]; // Application link goes Here!
